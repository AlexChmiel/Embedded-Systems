...
try {
	...
	//	for (int i=0;i<strs.length;i++)
	 ...
	 //      System.out.println(n);
		...
		case "IfStmt":
			  // type = strs[strs.length-2].substring(1, strs[strs.length-2].length()-1);
			   String op2 = strs[strs.length-1].substring(1, strs[strs.length-1].length()-1);
		       n = new IfStmt(pos,op2);
		//       System.out.println(n);
		       break;
		case "WhileStmt":
			  // type = strs[strs.length-2].substring(1, strs[strs.length-2].length()-1);
			   String op3 = strs[strs.length-1].substring(1, strs[strs.length-1].length()-1);
		       n = new WhileStmt(pos,op3);
		//       System.out.println(n);
		       break;
		}
