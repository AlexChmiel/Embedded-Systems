...
public class BinaryOperator extends Node{
	...
	//	System.out.println("Binaryoperator -eval");
        ...
        case "+":
	    	...
	    	return v;
        case "-":
        	Variable m = new Variable("",left.val-right.val);
        	
        	return m;
        case "*":
        	Variable j = new Variable("",left.val*right.val);
        	
        	return j;
        case "/":
        	Variable d = new Variable("",left.val/right.val);
        	
        	return d;
        case "|":
        	Variable f = new Variable("",left.val|right.val);
        	
        	return f;
        case "&":
        	Variable p = new Variable("", left.val&right.val);
